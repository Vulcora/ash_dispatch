defmodule AshDispatch.ChannelResolver do
  ...
  def to_channel_struct(%AshDispatch.Dsl.Channel{} = dsl_channel) do
    %Channel{
      ...
      idempotency_source: dsl_channel.idempotency_source,
      optional: dsl_channel.optional || false,
      exclude_actor: dsl_channel.exclude_actor || false,
  ...
  def to_channel_struct(channel) when is_map(channel) do
    %Channel{
      ...
      idempotency_source: Map.get(channel, :idempotency_source),
      optional: Map.get(channel, :optional, false),
      exclude_actor: Map.get(channel, :exclude_actor, false),
  ...
  def to_channel_struct(channel) when is_list(channel) do
    %Channel{
      ...
      idempotency_source: Keyword.get(channel, :idempotency_source),
      optional: Keyword.get(channel, :optional, false),
      exclude_actor: Keyword.get(channel, :exclude_actor, false),
